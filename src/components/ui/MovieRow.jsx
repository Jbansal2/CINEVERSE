...
const MovieRow = ({ title, movies, loading }) => {
    ...
    const maxScroll = Math.max(0, (movies.length - 6) * 260);

    const scrollLeft = () => {
        setScrollPosition(Math.max(0, scrollPosition - 1560));
    };
        ...
        <div className="mb-8">
            ...
            <div className="relative group px-4 md:px-12">
                <div className="overflow-hidden">
                    <div
                        className="flex    duration-500 ease-in-out gap-1"
                    ...
                    >
                        {movies.map((movie) => (
                            <Link
                                ...
                                to={`/movie/${movie.id}`}
                                className="min-w-[220px] md:min-w-[260px]  cursor-pointer transform transition-all duration-300 hover:scale-105 group relative"
                            >
